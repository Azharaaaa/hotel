            ...
            <div className="container">
                <div className="outside__row">
                        ...
                        >
                            <SwiperSlide>
                                <div className="outside__card">
                                    <img src={food} alt="" className="outside__card-img"/>
                    ...
                    <div className="outside__content">
                        <h2 className="outside__title">Practicalities</h2>
                        <div className="outside__links">
                            <a href="" className="outside__link">Breakfast</a>
                            <a href="" className="outside__link">Classic Dinner</a>
                        </div>
